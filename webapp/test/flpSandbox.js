		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#apontamentoapontamentodehoras-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apontamentoapontamentodehoras-display": {
								"semanticObject": "apontamentoapontamentodehoras",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apontamento.apontamentodehoras",
									"url": sap.ui.require.toUrl("apontamento/apontamentodehoras")
								}
							}
						}
					}
